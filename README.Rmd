...
In order to create a new package the user should go to the shinyypr [GitHub repository](https://github.com/poissonconsulting/shinyypr) and choose 'Use this template'.

shinyypr includes files used for development of Shiny applications. To remove these from the repository, run:
```{r, eval=FALSE}
