...
## Demonstration
The function `run_ypr_app()` has a single argument, `population` which can be used to pass 
a valid ypr_population object to automatically fill in app the parameters. Running the app with default argument will simply open the app and populate parameters with their defaults.
```{r, eval=FALSE}
